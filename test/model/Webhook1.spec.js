...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Webhook1', function() {
      beforeEach(function() {
        instance = new Mimepost.Webhook1();
      });

      it('should create an instance of Webhook1', function() {
        // TODO: update the code to test Webhook1
        expect(instance).to.be.a(Mimepost.Webhook1);
      });
