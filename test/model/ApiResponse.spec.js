  ...
  describe('(package)', function() {
    describe('ApiResponse', function() {
      ...
      it('should have the property error_code (base name: "error_code")', function() {
        // TODO: update the code to test the property error_code
        expect(instance).to.have.property('error_code');
        // expect(instance.error_code).to.be(expectedValueLiteral);
      });
